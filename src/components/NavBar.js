  ...
  return (
    <header className="w-full px-32 py-8 z-10 lg:px-16 md:px-12 sm:px-8 font-medium flex items-center justify-between dark:text-light relative">
      ...
      >
        ...
        ></span>
        <span
          className={`bg-dark block h-0.5 w-6 rounded-sm  transition-all duration-300 ease-out  my-0.5 ${
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col justify-between
           z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2
            -translate-y-1/2 bg-dark/90 rounded-lg backdrop-blur-md py-32"
        >
